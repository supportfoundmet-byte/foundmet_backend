...
export const verifyAuth = (req, res, next) => {
  try {
    ...
    try {
      ...
      return sendError(res, 401, "Invalid or expired session. Please log in again.", "INVALID_SESSION");
    }
    ...
    UserModel.findById(decoded._id)
      ...
      .then((user) => {
        if (!user || user.isDeleted) {
          return sendError(res, 401, "This account is no longer available. Please log in again.", "ACCOUNT_UNAVAILABLE");
        }
